...
var clientOptions = options.Client().ApplyURI("mongodb+srv://parqueouniajcestudianteS941:parqueouniajcestudianteS94135498261@cluster0.cneao.mongodb.net/parqueouniajc?retryWrites=true&w=majority")
